...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% I got an output without bib/reference in the CV if using "Compile PDF" in RStudio
% solve this issue:
...
\mynames{Zhang/Dada, Zhang/D.\bibnamedelima Z., Zhang/Dada\bibnamedelimi Zhang}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Dada Zhang, Graduate Student}

  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}{\texttt{dzhang19@huskers.unl.edu}}}
  ...
  {\href{http://www.linkedin.com/in/example/}{\texttt{https://www.linkedin.com/in/dada-zhang-9a8359302/}}}
}
